...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference("Candidate.count") do
      post candidates_url, params: { candidate: { constituency_id: @candidate.constituency_id, partyname: @candidate.partyname } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { constituency_id: @candidate.constituency_id, partyname: @candidate.partyname } }
